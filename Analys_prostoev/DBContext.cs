namespace Analys_prostoev
{
    public static class DBContext
    {
        ...
        static public string insertQuery = "INSERT INTO analysis (date_start, date_finish, period, region, status, is_manual) VALUES (@dateStart, @dateFinish, @period, @region, @status, @is_manual)";
