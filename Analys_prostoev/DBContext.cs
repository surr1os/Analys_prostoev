namespace Analys_prostoev
{
    public class DBContext
    {
        ...
        static public string changeQuery = "UPDATE analysis SET status = @status, change_at = @change_at, shifts = @shifts WHERE \"Id\" = @id";
        static public string insertQuery = "INSERT INTO analysis (date_start, date_finish, status, period, region, is_manual, created_at, change_at) VALUES (@dateStart, @dateFinish,@status, @period, @region,  @is_manual, @created_at, @change_at)";
